...
RSpec.describe 'Edit features' do
  ...
  subject do
    ...
    visit edit_attendee_registration_path
  ...
  context 'testing fields to update' do
    it 'updates successfully' do
      subject
      expect(current_path).to eql(edit_attendee_registration_path)
  ...
  it 'testing password to not update without current password' do
    ...
    subject
    expect(current_path).to eql(attendee_registration_path)
  ...
  it 'fails if details are invalid' do
    ...
    subject
    expect(current_path).to eql(attendee_registration_path)
    expect(page).to have_content('errors prohibited this attendee from being saved')
  end
end
